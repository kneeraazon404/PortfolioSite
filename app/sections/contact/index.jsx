...
export function ContactMe() {
    ...
    return (
        <LazyMotion features={domAnimation}>
            <section id="tech" className="section  my-16">
                <HeadingDivider title="Get In Touch" className="py-16" />

                <div className="relative isolate">
                    <div className="mx-auto my-16 grid max-w-7xl grid-cols-1 lg:grid-cols-2">
                        <div className="relative px-6  mb-16  mt-16 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-2.5">
                                            <input
                                                ...
                                                className="block w-full rounded-md border-0 dark:bg-white/5 px-3.5 py-2  shadow-sm ring-1 ring-inset dark:ring-white/20 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6"
                                            />
                                        </div>
                                    </div>
                                    <div>
