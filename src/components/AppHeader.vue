	...
	<nav id="nav" class="sm:container sm:mx-auto">
		...
		>
			...
			>
				...
				>	
					<a
					href="https://kneeraazon.hashnode.dev"
					target="_blank"
					class="block text-left text-lg font-medium text-primary-dark dark:text-ternary-light hover:text-secondary-dark dark:hover:text-secondary-light  sm:mx-4 mb-2 sm:py-2 border-t-2 pt-3 sm:pt-2 sm:border-t-0 dark:border-secondary-dark"
					aria-label="blog"
					>Blog</a>
