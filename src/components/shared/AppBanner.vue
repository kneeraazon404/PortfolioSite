  ...
  >
    ...
    <div class="w-full md:w-1/3 text-left">
      ...
      <div class="flex justify-center sm:block">
        <a
          download="Nirajan-Resume.pdf"
          href="/files/resume.pdf"
          class="flex justify-center items-center w-36 sm:w-48 mt-12 mb-6 sm:mb-0 text-lg border border-indigo-100 dark:border-ternary-dark py-2.5 sm:py-3 shadow-lg rounded-lg bg-indigo-500 focus:ring-1 focus:ring-indigo-900 hover:bg-indigo-50 text-white hover:text-gray-500 duration-500"
